      ...
      <div className="container relative z-10 px-4 py-20 mx-auto text-center">
        ...
        <div className="flex justify-center mb-10 animate-fade-in">
          <img
            src={logoPSafe}
            alt="PSafe Advocacia"
            className="w-40 md:w-56 object-contain drop-shadow-lg"
          />
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <p
            className="text-xl md:text-2xl text-white/90 font-light max-w-3xl mx-auto animate-fade-in"
          ...
          <div
            className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 animate-scale-in"
          ...
          <div
            className="flex flex-wrap justify-center gap-6 pt-8 text-sm text-white/80 animate-fade-in"
